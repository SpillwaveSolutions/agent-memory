...
**Acceptance:**
- [x] e2e above passes; a second `backfill-index` run reports 0 new
      documents
- [x] `--dry-run` prints counts and writes nothing (checkpoint unchanged)
- [x] Interrupting mid-run (test sends SIGINT after batch 1) and re-running
      resumes from the checkpoint
- [x] README and UPGRADING updated in the same PR
...
- [x] OPS-01: v3.0 fixture store backfills and searches (61-01)
