...
Plans:
- [x] 35-01: InFlightBuffer data structure + DedupConfig in memory-types -- completed 2026-03-05
- [x] 35-02: Enhanced NoveltyChecker wired to real CandleEmbedder and HnswIndex with fail-open + unit tests -- completed 2026-03-05
...
Plans:
- [x] 36-01-PLAN.md -- Core dedup wiring: put_event_only, EventType::is_structural, CandleEmbedderAdapter, NoveltyChecker injection into ingest_event
- [x] 36-02-PLAN.md -- Proto additions (deduplicated field, GetDedupStatus RPC), daemon startup wiring with fail-open CandleEmbedder
- [x] 36-03-PLAN.md -- Gap closure: Wire HNSW index into NoveltyChecker via CompositeVectorIndex for cross-session dedup (DEDUP-02)
...
Plans:
- [x] 37-01-PLAN.md -- StalenessConfig + StaleFilter with time-decay, kind exemptions + metadata enrichment in SimpleLayerExecutor
- [x] 37-02-PLAN.md -- Supersession detection via embedding retrieval + wire StaleFilter into route_query
- [x] 37-03-PLAN.md -- Gap closure: Wire StalenessConfig from Settings through daemon startup to RetrievalHandler (RETRV-04)
...
Plans:
- [ ] 38-01-PLAN.md -- E2E dedup tests: MockEmbedder helpers + duplicate stored-but-not-indexed, structural bypass, response fields (TEST-01)
- [ ] 38-02-PLAN.md -- E2E stale filtering tests: time-decay downranking, kind exemptions, disabled control (TEST-02)
- [ ] 38-03-PLAN.md -- E2E fail-open tests: embedder disabled, embedder error, StaleFilter no-timestamp (TEST-03)
...
| 37 | v2.5 | Complete    | 2026-03-09 | 2026-03-09 |
| 38 | v2.5 | Complete    | 2026-03-10 | - |

---

*Updated: 2026-03-09 after phase 38 planning complete*
